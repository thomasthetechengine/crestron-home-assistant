...
This node js server mimics a crestron panel, in your controller, assign one of your IP 's to an XPanel, which this node js server will be sending and recieving from.
